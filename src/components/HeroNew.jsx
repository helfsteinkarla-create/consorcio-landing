  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img 
          src="/src/assets/images/karla-hero-bg.jpg" 
          alt="Karla Helfstein" 
          className="w-full h-full object-cover object-center"
        />
        {/* Gradient Overlay - Mais forte no lado esquerdo para legibilidade do texto */}
        <div className="absolute inset-0 bg-gradient-to-r from-blue-950/95 via-blue-900/85 to-blue-800/60"></div>
        {/* Gradient Overlay adicional de cima para baixo */}
